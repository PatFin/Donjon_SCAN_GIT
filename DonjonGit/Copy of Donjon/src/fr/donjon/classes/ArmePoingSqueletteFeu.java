 ...
 *
 */
public class ArmePoingSqueletteFeu extends Arme{
	 ...
	 * @param lanceur
	 */
	public ArmePoingSqueletteFeu(Personnage lanceur, int dommages) {
	...
	public int utilise(Personnage p) {
		p.arme = new ArmePoingSqueletteFeu(p,12);
		return 0;
	}
