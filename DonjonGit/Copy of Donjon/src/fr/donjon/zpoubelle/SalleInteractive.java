...
/**
 * 
 * Cette classe est une Salle qui poss�de un ecouteur de changement de salle, lorsque le joueur marche
 * sur une case escalier l'ecouteur (Gestionnaire) est pr�venu qu'il faut changer de salle
 * 
 * @author Baptiste
 *
 */
public class SalleInteractive extends Salle implements EcouteurClavier{
	...
	public void update(long temps) {
		...
		//G�re les collisions avec les escaliers
		//A am�lieorer !
