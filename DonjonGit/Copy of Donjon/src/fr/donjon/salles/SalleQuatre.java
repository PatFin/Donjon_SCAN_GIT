...
/**
 * 
 * Salle qui est destinÃ©e Ã  ne contenir que Quatre portes au maximum au points cardinaux,
 * la gestion du changement de salle et simplifiÃ©e pour ce type de salle.
 * 
 * @author Baptiste
 *
 */
public class SalleQuatre extends Salle {
	...
	/**
	 * Detecte les salles potentielles situï¿½es autours de cette instance
	...
	/**
	 * Donne la case porte de l'orientation donnÃ©e en parametre
	 * 
	 * @param o l'orientation de la porte souhaitÃ©e
	 * 
	 * @return La CasePorte dans l'orientation souhaitÃ©e, celle ci est unique car on est dans une SalleQuatre
	 */
