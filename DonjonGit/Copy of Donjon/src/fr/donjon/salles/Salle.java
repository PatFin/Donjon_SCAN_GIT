...
public abstract class Salle implements EcouteurClavier{
	...
	/**
	 * Crée toutes les portes dans la salle s'il peut exister une salle à coté de cette instance.
	 * Voir dans la classe SalleQuatre pour plus de précisions
	 * 
	 * @param sMap le tableau de salles
	 */
	//TODO Bouger cette méthode dans SalleQuatre et adapter le code du gestionnaire
